...
import "../../style/Invitado/RegistroForm.css";
...
const RegistroForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.status === 404) {
        // No está en la escuela → ir a matriculación
        window.location.href = "/matriculacion";
        return;
      }
      ...
      <div className="registro-inner">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="registro-field">
            ...
            <input className="registro-input" type="text" name="nombre"
          ...
          <div className="registro-field">
            ...
            <input className="registro-input" type="text" name="apellido"
              placeholder="apellidos" value={form.apellido}
              onChange={handleChange} required />
          </div>
          ...
          <div className="registro-field">
            ...
            <input className="registro-input" type="password" name="password"
          ...
          <div className="registro-field">
            ...
            <input className="registro-input" type="password" name="confirmar"
              placeholder="••••••••••" value={form.confirmar}
              onChange={handleChange} required />
          </div>

          <label className="registro-terminos">
            <input type="checkbox" name="terminos"
              checked={form.terminos} onChange={handleChange} required />
          ...
          <div style={{
            ...
            ℹ️ Si ya eres alumno de la escuela, tu cuenta se creará automáticamente.
            Si no, serás redirigido al formulario de inscripción.
          </div>
